...
| `viewers/windows/src/win/mod.rs` | ~780 lines — the Windows window: input → `Viewer`, threads, messages |
| `viewers/windows/src/win/paint.rs` | ~800 lines — GDI drawing by `Viewer::layout` |
